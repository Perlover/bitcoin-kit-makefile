...
bash_profile_update:
	...
	echo $$'#PATH=/home/bitcoin/gcc/bin:$$PATH:$$HOME/bin:/home/bitcoin/bitcoin-core/bin';\
	echo $$'export PATH';\
	echo $$'export LD_LIBRARY_PATH="/home/bitcoin/lib:/home/bitcoin/gcc/lib/../lib64:/home/bitcoin/bitcoin-core/lib"';\
	echo $$'export LD_RUN_PATH=$$LD_LIBRARY_PATH';\
	echo $$'export MANPATH="/home/bitcoin/share/man:/home/bitcoin/gcc/share/man:$$MANPATH"';\
	echo $$'export CPPFLAGS="-I$$HOME/include"';\
	echo $$'export LDFLAGS="-L$$HOME/lib/"'; } >>$$HOME/.bash_profile
	@touch $@
...
autoconf_install: autoconf-2.69.tar.gz
...
libtool_install: libtool-2.4.6.tar.gz
...
automake_install: automake-1.15.tar.gz
...
# mpfr
mpfr-3.1.5.tar.bz2: | gmp_install
...
mpfr_install: mpfr-3.1.5.tar.bz2
