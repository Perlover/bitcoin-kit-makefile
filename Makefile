...
# commit/tag of LND for installation - master branch, v0.11.1-beta.rc5 (v0.11.1-beta.rc5 == v0.11.1-beta) as minimum + wumbo channel commits
LND_ACTUAL_COMMIT := a2058e2ebf9df500d4f21be2ead7079df546c949
