...
"
	...
	echo "\
BITCOIN_KIT_LND_CONFIG_EXTERNALIP_MAINNET := externalip=$BITCOIN_KIT_REAL_PUBLIC_IP:9735\\n
BITCOIN_KIT_LND_CONFIG_EXTERNALIP_TESTNET := externalip=$BITCOIN_KIT_REAL_PUBLIC_IP:9736\\n
BITCOIN_KIT_BITCOIND_CONFIG_EXTERNALIP_MAINNET := externalip=$BITCOIN_KIT_REAL_PUBLIC_IP\\n
BITCOIN_KIT_BITCOIND_CONFIG_EXTERNALIP_TESTNET := externalip=$BITCOIN_KIT_REAL_PUBLIC_IP\\n\
"
...
BITCOIN_KIT_LND_CONFIG_EXTERNALIP_TESTNET :=
BITCOIN_KIT_BITCOIND_CONFIG_EXTERNALIP_MAINNET :=
BITCOIN_KIT_BITCOIND_CONFIG_EXTERNALIP_TESTNET :=\
"
    fi

} > $1

# bash environments, now it's not used, may be removed
{
    echo "\
export BITCOIN_KIT_UPNP_SUPPORT=\"$BITCOIN_KIT_UPNP_SUPPORT\"
export BITCOIN_KIT_LOCAL_IP=\"$BITCOIN_KIT_LOCAL_IP\"
export BITCOIN_KIT_REAL_PUBLIC_IP=\"$BITCOIN_KIT_REAL_PUBLIC_IP\"
export BITCOIN_KIT_EXTERNAL_ROUTER_IP=\"$BITCOIN_KIT_EXTERNAL_ROUTER_IP\"
export BITCOIN_KIT_BEHIND_ROUTER=\"$BITCOIN_KIT_BEHIND_ROUTER\"
export BITCOIN_KIT_POSSIBLE_INCOMING_CONNECTIONS=\"$BITCOIN_KIT_POSSIBLE_INCOMING_CONNECTIONS\"
export BITCOIN_KIT_SHOULD_CONFIGURE_ROUTER_PORT_FORWARDING=\"$BITCOIN_KIT_SHOULD_CONFIGURE_ROUTER_PORT_FORWARDING\"\
"
    if [ $BITCOIN_KIT_POSSIBLE_INCOMING_CONNECTIONS == 'Yes' ]; then
	echo "\
export BITCOIN_KIT_LND_CONFIG_EXTERNALIP_MAINNET=\"externalip=$BITCOIN_KIT_REAL_PUBLIC_IP:9735\\n\"
export BITCOIN_KIT_LND_CONFIG_EXTERNALIP_TESTNET=\"externalip=$BITCOIN_KIT_REAL_PUBLIC_IP:9736\\n\"
export BITCOIN_KIT_BITCOIND_CONFIG_EXTERNALIP_MAINNET=\"externalip=$BITCOIN_KIT_REAL_PUBLIC_IP\\n\"
export BITCOIN_KIT_BITCOIND_CONFIG_EXTERNALIP_TESTNET=\"externalip=$BITCOIN_KIT_REAL_PUBLIC_IP\\n\"\
"
    elif [ $BITCOIN_KIT_POSSIBLE_INCOMING_CONNECTIONS == 'Maybe' ]; then
	echo "\
...
"
	...
	echo "\
export BITCOIN_KIT_LND_CONFIG_EXTERNALIP_MAINNET=
export BITCOIN_KIT_LND_CONFIG_EXTERNALIP_TESTNET=
export BITCOIN_KIT_BITCOIND_CONFIG_EXTERNALIP_MAINNET=
export BITCOIN_KIT_BITCOIND_CONFIG_EXTERNALIP_TESTNET=\
"
    fi
